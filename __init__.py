...
from raylight.comfy_extra_dist.nodes_spectrum_h3 import NODE_CLASS_MAPPINGS as SPECTRUM_H3_NODE_CLASS_MAPPINGS
from raylight.comfy_extra_dist.nodes_spectrum_h3 import NODE_DISPLAY_NAME_MAPPINGS as SPECTRUM_H3_DISPLAY_NAME_MAPPINGS
from raylight.comfy_extra_dist.nodes_te_speed_h3 import NODE_CLASS_MAPPINGS as TE_SPEED_H3_NODE_CLASS_MAPPINGS
from raylight.comfy_extra_dist.nodes_te_speed_h3 import NODE_DISPLAY_NAME_MAPPINGS as TE_SPEED_H3_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(SPECTRUM_H3_NODE_CLASS_MAPPINGS)
NODE_CLASS_MAPPINGS.update(TE_SPEED_H3_NODE_CLASS_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(SPECTRUM_H3_DISPLAY_NAME_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(TE_SPEED_H3_DISPLAY_NAME_MAPPINGS)
